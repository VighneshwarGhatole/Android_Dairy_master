package com.mobilophilia.masterdairy.common;
...
public class Constants {
    ...
    public static final String GETMANAGER_DATA = BASE_URL + "Api/getmanagerInfo";
    ...
    public static final String[] agent = new String[]{"Agent1", "Agent2","Agent3", "Agent4","Agent5", "Agent6","Agent7", "Agent8","Agent9", "Agent10","Agent11", "Agent12"};
    public static final String[] dairyName = new String[]{"Dairy1", "Dairy2","Dairy3", "Dairy4","Dairy5", "Dairy6","Dairy7", "Dairy8","Dairy9", "Dairy10","Dairy11", "Dairy12"};
    ...
    public static final String VALIDATION_DAIRY_NAME = "Dairy name can not be blank";
    public static final String VALIDATION_DAIRY_CARE_BY = "Dairy caretaker name can not be blank";
    public static final String VALIDATION_DAIRY_ADDRESS = "Dairy address can not be blank";
    ...
    public static final int ACTIVITY_RESULT_CODE_DAIRY_NAME = 8000;
