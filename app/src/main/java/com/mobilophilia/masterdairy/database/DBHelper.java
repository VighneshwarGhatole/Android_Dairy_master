...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static final String TABLE_DAIRY_DETAILS = "tbDairyDetails";
    private static final String TABLE_PROVIDER_ENTRY = "tbProviderEntry";
    // Common column names
    ...
    private static final String KEY_DAIRY_NAME = "dairyName";
    private static final String KEY_DAIRY_CARE_TAKER = "CareTaker";
    private static final String KEY_DAIRY_PHONE = "dairyPhone";
    private static final String KEY_DAIRY_ADDRESS = "dairyAddress";
    ...
    private static final String KEY_DAIRY_ID = "dairyId";
    ...
    //Provider Entry
    private static final String KEY_PRO_CHILLING_EX = "proChillingEx";
    private static final String KEY_PRO_FAT = "proFat";
    private static final String KEY_PRO_SNF = "proSnf";
    private static final String KEY_PRO_LTR = "proLtr";
    private static final String KEY_PRO_PRICE = "proPrice";
    private static final String KEY_PRO_TOTAL = "proTotal";
    private static final String KEY_OTHER_EX = "proOtherEx";
    ...
    // Table Create Statements for dairy details
    private static final String CREATE_TABLE_DAIRY_DETAILS = "CREATE TABLE "
            + TABLE_DAIRY_DETAILS + "(" + KEY_ID + " INTEGER PRIMARY KEY,"
            + KEY_AGENT_ID + " TEXT,"
            + KEY_DAIRY_NAME + " TEXT,"
            + KEY_DAIRY_CARE_TAKER + " TEXT,"
            + KEY_DAIRY_PHONE + " TEXT,"
            + KEY_DAIRY_ADDRESS + " TEXT,"
            + KEY_CREATED_AT + " DATETIME" + ")";
    ...
    private static final String CREATE_TABLE_PROVIDER_ENTRY = "CREATE TABLE "
            + TABLE_PROVIDER_ENTRY + "(" + KEY_ID + " INTEGER PRIMARY KEY,"
            + KEY_AGENT_ID + " TEXT,"
            + KEY_DAIRY_NAME + " TEXT,"
            + KEY_PRO_LTR + " TEXT,"
            + KEY_PRO_FAT + " TEXT,"
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(CREATE_TABLE_DAIRY_DETAILS);
        db.execSQL(CREATE_TABLE_PROVIDER_ENTRY);
    }
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS " + CREATE_TABLE_DAIRY_DETAILS);
        db.execSQL("DROP TABLE IF EXISTS " + CREATE_TABLE_PROVIDER_ENTRY);
    ...
    public long createSetPriceEntry(SetPriceEntry setPriceEntry) {
        ...
        values.put(KEY_DAIRY_ID, setPriceEntry.getDairyID());
    ...
    public List<SetPriceEntry> getAllSetPrice() {
        ...
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor c = db.query(TABLE_SET_PRICE, null, KEY_AGENT_ID + " = ?", new String[]{mAgentID}, null, null, KEY_DAIRY_ID + " DESC", null);
        ...
        if (c.moveToFirst()) {
            do {
                ...
                sep.setDairyID((c.getInt(c.getColumnIndex(KEY_DAIRY_ID))));
    ...
    public void synchDataServer(Context context) {
        ...
        try {
            for (int i = 0; i < addedNameList(timeStamp).size(); i++) {
                ...
                nameObj.put("code", name.getNameCode());
                nameObj.put("name", name.getEnterName());
                nameObj.put("type", Util.getTypeFromSelected(name.getType()));
                nameObj.put("phone", name.getPhoneNo());
                nameObj.put("createdAt", name.getCreatedAt());
            ...
            for (int i = 0; i < addedSetPrice(timeStamp).size(); i++) {
                ...
                priceObj.put("lFat", price.getLowFat());
                priceObj.put("hFat", price.getHighFat());
                priceObj.put("lSnf", price.getLowSnf());
                priceObj.put("hSnf", price.getHighSnf());
                priceObj.put("startPrice", price.getStartPrice());
                priceObj.put("fatIntetval", price.getFatInterval());
                priceObj.put("snfIntetval", price.getSnfInterval());
                priceObj.put("type", price.getType());
                priceObj.put("time", price.getTime());
                priceObj.put("createdAt", price.getCreatedAt());
            ...
            for (int i = 0; i < addedEntries(timeStamp).size(); i++) {
                ...
                entryObj.put("code", entry.getCode());
                entryObj.put("crl", entry.getClr());
                entryObj.put("fat", entry.getFat());
                entryObj.put("snf", entry.getSnf());
                entryObj.put("ltr", entry.getLtr());
                entryObj.put("price", entry.getPrice());
                entryObj.put("total", entry.getTotal());
                entryObj.put("more", entry.getMorOrEveTime());
                entryObj.put("createdAt", entry.getCreatedAt());
            ...
            for (int i = 0; i < addedExpenses(timeStamp).size(); i++) {
                ...
                expObj.put("code", entry.getCode());
                expObj.put("expense", entry.getExpense());
                expObj.put("createdAt", entry.getCreatedAt());
    ...
    /**
     * get Add Dairy deatails
     */
    public long addDairyDatail(DairyDetailsBean bean) {
        SQLiteDatabase db = this.getWritableDatabase();

        ContentValues values = new ContentValues();
        values.put(KEY_AGENT_ID, mAgentID);
        values.put(KEY_DAIRY_NAME, bean.getDairyName());
        values.put(KEY_DAIRY_CARE_TAKER, bean.getDairyCareBy());
        values.put(KEY_DAIRY_PHONE, bean.getDairyPhone());
        values.put(KEY_DAIRY_ADDRESS, bean.getDairyAddress());
        values.put(KEY_CREATED_AT, timeStamp());
        // insert row
        long name_id = db.insert(TABLE_DAIRY_DETAILS, null, values);
        EventBus.getDefault().post(new MessageEvent(MessageEvent.SYNC_ICON_ON));
        return name_id;
    }
    ...
    /**
     * get single dariy deatails
     */

    public DairyDetailsBean getDairyDetail(int id) {
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor c = db.query(TABLE_DAIRY_DETAILS, null, KEY_AGENT_ID + " = ? AND " + KEY_ID + " = ?", new String[]{mAgentID, "" + id}, null, null, null);
        DairyDetailsBean bean = null;
        if (c != null && c.getCount() > 0) {
            c.moveToFirst();
            bean = new DairyDetailsBean();
            bean.setId(c.getInt(c.getColumnIndex(KEY_ID)));
            bean.setDairyName((c.getString(c.getColumnIndex(KEY_DAIRY_NAME))));
            bean.setDairyCareBy((c.getString(c.getColumnIndex(KEY_DAIRY_CARE_TAKER))));
            bean.setDairyPhone((c.getString(c.getColumnIndex(KEY_DAIRY_PHONE))));
            bean.setDairyAddress((c.getString(c.getColumnIndex(KEY_DAIRY_ADDRESS))));
            bean.setCreatedAt(c.getString(c.getColumnIndex(KEY_CREATED_AT)));
    ...
    public List<DairyDetailsBean> getDairyList() {
        List<DairyDetailsBean> listDairyList = new ArrayList<DairyDetailsBean>();

        SQLiteDatabase db = this.getReadableDatabase();
        Cursor c = db.query(TABLE_DAIRY_DETAILS, null, KEY_AGENT_ID + " = ?", new String[]{mAgentID}, null, null, null);
        String dateHeader = "";
        String time = "";
        if (c.moveToFirst()) {
            do {
                ...
                DairyDetailsBean ene = new DairyDetailsBean();
                ene.setContentType(1);
                ene.setHeaderText(time);// In this Time
                ene.setId(c.getInt(c.getColumnIndex(KEY_ID)));
                ene.setDairyName((c.getString(c.getColumnIndex(KEY_DAIRY_NAME))));
                ene.setDairyCareBy((c.getString(c.getColumnIndex(KEY_DAIRY_CARE_TAKER))));
                ene.setDairyPhone((c.getString(c.getColumnIndex(KEY_DAIRY_PHONE))));
                ene.setDairyAddress((c.getString(c.getColumnIndex(KEY_DAIRY_ADDRESS))));
                ene.setCreatedAt(c.getString(c.getColumnIndex(KEY_CREATED_AT)));
                listDairyList.add(ene);

            } while (c.moveToNext());
        }
        return listDairyList;
    }


    public List<String> getDairyNames(boolean isProviderView) {
        List<String> list = new ArrayList<String>();

        SQLiteDatabase db = this.getReadableDatabase();
        Cursor c = db.query(TABLE_DAIRY_DETAILS, new String[]{KEY_ID, KEY_DAIRY_NAME}, KEY_AGENT_ID + " = ?", new String[]{mAgentID}, null, null, null);

        if (c.moveToFirst()) {
            do {
                String name = c.getString(c.getColumnIndex(KEY_DAIRY_NAME));
                list.add(name);
            } while (c.moveToNext());
        }
        if (isProviderView)
    ...
    public List<DairyDetailsBean> getDairyNameList(boolean isProviderView) {
        List<DairyDetailsBean> listDairyList = new ArrayList<DairyDetailsBean>();
        ...
        if (isProviderView) {
            DairyDetailsBean ene = new DairyDetailsBean();
            ene.setDairyName("Customer");
            listDairyList.add(ene);
        }
        return listDairyList;
    }

    public int updateDairy(DairyDetailsBean bean) {
        SQLiteDatabase db = this.getWritableDatabase();
        ...
        // updating row
        //EventBus.getDefault().post(new MessageEvent(MessageEvent.SYNC_ICON_ON));
        return db.update(TABLE_DAIRY_DETAILS, values, KEY_ID + " = ?", new String[]{String.valueOf(bean.getId())});
    ...
    public void deleteDairy(int id) {
        SQLiteDatabase db = this.getWritableDatabase();
        db.delete(TABLE_DAIRY_DETAILS, KEY_ID + " = ?", new String[]{String.valueOf(id)});
    }
    ...
    public long addProviderEntry(ProviderBean bean) {
        SQLiteDatabase db = this.getWritableDatabase();

        ContentValues values = new ContentValues();
        values.put(KEY_AGENT_ID, mAgentID);
        values.put(KEY_DAIRY_NAME, bean.getDariyName());
        values.put(KEY_PRO_LTR, bean.getLtr());
        values.put(KEY_PRO_FAT, bean.getAvgFat());
        values.put(KEY_PRO_SNF, bean.getAvgSnf());
        values.put(KEY_PRO_PRICE, bean.getAvgPrice());
        values.put(KEY_PRO_CHILLING_EX, bean.getChillingEx());
        values.put(KEY_OTHER_EX, bean.getOtherEx());
        values.put(KEY_PRO_TOTAL, bean.getTotalPrice());
        values.put(KEY_CREATED_AT, timeStamp());
        // insert row
        long name_id = db.insert(TABLE_PROVIDER_ENTRY, null, values);
        EventBus.getDefault().post(new MessageEvent(MessageEvent.SYNC_ICON_ON));
        return name_id;
    }


    public List<ProviderBean> getProviderEntry() {
        List<ProviderBean> list = new ArrayList<ProviderBean>();

        SQLiteDatabase db = this.getReadableDatabase();
        Cursor c = db.query(TABLE_PROVIDER_ENTRY, null, KEY_AGENT_ID + " = ?", new String[]{mAgentID}, null, null, KEY_CREATED_AT + " DESC", null);

        if (c.moveToFirst()) {
            do {
                ProviderBean myEBean = new ProviderBean();
                myEBean.setDariyName(c.getString(c.getColumnIndex(KEY_DAIRY_NAME)));
                myEBean.setLtr(c.getString(c.getColumnIndex(KEY_PRO_LTR)));
                myEBean.setAvgFat(c.getString(c.getColumnIndex(KEY_PRO_FAT)));
                myEBean.setAvgSnf(c.getString(c.getColumnIndex(KEY_PRO_SNF)));
                myEBean.setAvgPrice(c.getString(c.getColumnIndex(KEY_PRO_PRICE)));
                myEBean.setChillingEx(c.getString(c.getColumnIndex(KEY_PRO_CHILLING_EX)));
                myEBean.setOtherEx(c.getString(c.getColumnIndex(KEY_OTHER_EX)));
                myEBean.setTotalPrice(c.getString(c.getColumnIndex(KEY_PRO_TOTAL)));
                list.add(myEBean);
            } while (c.moveToNext());
        }
        return list;
    ...
    public float getProviderEntryLtr() {
       float totalLtr = 0l;
        ...
        if (c.moveToFirst()) {
            do {
                ProviderBean myEBean = new ProviderBean();
                totalLtr = totalLtr+Float.parseFloat(c.getString(c.getColumnIndex(KEY_PRO_LTR)));
    ...
    public static String timeStampForManagerData() {
        String timeStamp = getDateTimeForManager();
        Date date = null;
        try {
    ...
    private static String getDateTimeForManager() {
