...
public class SetPriceFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final List<DairyDetailsBean> listDairyList = dbHelper.getDairyNameList(true);
        priceType = (Spinner) rootView.findViewById(R.id.spinner_price_type);
        SpinnerAdapter spAd = new SpinnerAdapter(getActivity(),listDairyList);
        priceType.setAdapter(spAd);
        priceType.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                dairyId = listDairyList.get(position).getId();
